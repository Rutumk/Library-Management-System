...
def issueBook():
    ...
    headingFrame1 = Frame(root, bg="#37ff00", bd=5)
    headingFrame1.place(relx=0.25, rely=0.1, relwidth=0.5, relheight=0.13)

    headingLabel = Label(headingFrame1, text="Issue Book", bg='black', fg='#37ff00', font=('Courier', 15, 'bold'))
    ...
    lb3 = Label(labelFrame, text="Issued_Date : ", bg='black', fg='white')
