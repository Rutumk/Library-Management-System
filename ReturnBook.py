...
def returnBook():
    ...
    headingLabel = Label(headingFrame1, text="Return Book", bg='black', fg='#ff0000', font=('Courier', 15, 'bold'))
    ...
    lb2 = Label(labelFrame, text="Return Date : ", bg='black', fg='white')
    lb2.place(relx=0.05, rely=0.7)

    bookInfo2 = Entry(labelFrame)
    bookInfo2.place(relx=0.3, rely=0.7, relwidth=0.62)
